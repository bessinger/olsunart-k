...
exports.run = async (bot, message, args) => {
  ...
  .addField(`**<:fixit:793770061386743818> Blazing Kontrol**`, `${prefix}blazing-kontrol`, false)
  .addField(`**<:fixit:793770061386743818> Blazingler Listesi**`, `${prefix}blazing-liste`, false)
 ...
 return msg.channel.send(annencilermaldır);
  ...
  let onlycode = args.slice(0).join(' ');
    ...
    .addField(`**<:fixit:793770061386743818> Blazing Check**`, `${prefix}blazing-check`, false)
    .addField(`**<:fixit:793770061386743818> Blazing List**`, `${prefix}blazing-list`, false)
      .addField('\u200b', '\u200B')
