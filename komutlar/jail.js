...
if(!sebep) sebep = 'Sebep belirtilmemiş.'
  ...
  .addField(`<a:TR:742770235983003659> **Hapishaneye yollanan kişi:**`, kişi, true)
  .addField(`<a:TR:742770235983003659> **Hakim:**`, `<@${message.author.id}>`, true)
  .addField(`<a:TR:742770235983003659> **Sebep:**`, sebep, true)
  .addField(`<a:TR:742770235983003659> **Süre:**`, zaman.replace(/d/, ' gün').replace(/s/, ' saniye').replace(/m/, ' dakika').replace(/h/, ' saat'), true)
  .setTimestamp()
  ...
  .addField(`<a:wow:742770347161419898> **Tahliye olan:**`, kişi, true)
  .addField(`<a:wow:742770347161419898> **Hakim:**`, `<@${message.author.id}>`, true)
  .setTimestamp()
  .setColor(`#f3c7e1`)
