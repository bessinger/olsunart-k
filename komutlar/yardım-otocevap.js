...
.setColor('#ffffff') 
.setAuthor(`Bessinger Oto Cevap Komutları`, client.user.avatarURL())
.setDescription(`<a:Bessinger:749380925619437619> Bessinger botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
