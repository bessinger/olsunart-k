...
exports.run = async (client, message, args) => {
  if(message.author.id !== "676886594581692427") return message.channel.send("**Bu Komut Sahiplerime Özeldir.**");
...
client.channels.cache.get('676886594581692427').send(new Discord.MessageEmbed() .setDescription(`**<@${nesne}> ID\'li Kullanıcı Gold Üyeliğe Eklendi.**`) .setColor('BLUE'))
